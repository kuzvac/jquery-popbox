      ...
      open: function(event){
        ...
        if(box.css('display') == 'block'){
          ...
          if(settings['direction'] == 'right'){
            ...
            box.css({'display': 'block', 'left': ((pop.parent().width()/2) + box.width()/4), 'bottom': ((pop.parent().height()/2) - box.height()/2 )});
          }
          if(settings['direction'] == 'left'){
            box.css({'display': 'block', 'right': ((pop.parent().width()/2) + box.width()/4), 'bottom': ((pop.parent().height()/2) - box.height()/2 )});
          }
